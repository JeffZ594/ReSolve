...
int runTest(int argc, char *argv[])
{
  ...
  // Test export
//   std::ofstream A_output_file("A_output.mtx");
//   std::ofstream rhs_output_file("rhs_output.mtx");
//   error_sum += ReSolve::io::writeMatrixToFile(A, A_output_file);
//   error_sum += ReSolve::io::writeVectorToFile(vec_rhs, rhs_output_file);
